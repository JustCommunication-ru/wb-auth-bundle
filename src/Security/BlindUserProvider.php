...
class BlindUserProvider implements UserProviderInterface, PasswordUpgraderInterface
{
    /**
    ...
    public function refreshUser(UserInterface $user): UserInterface
    {
        ...
        //Все что здесь будет обновлено сработает только на текущую загрузку страницы, в сессию не будет сохранено
        //$user->setExt($user->getExt().rand(111,333));
        return $user; // возвращаем как есть, не обновляя
    }
